...
class QuestionGenerator:
    ...
    def generate_questions(self, interview_days):
        ...
        for mission in interview_days:
            ...
            day_info = next(
                (d for d in self.curriculum["days"] if d["day"] == day_number),
                None
            )
            if not day_info:
                continue
            ...
            questions.append({
                ...
                "question": (
                    f"Can you explain the concept of '{day_info['title']}' "
                    "and describe how you would implement it in a real project?"
                ),
